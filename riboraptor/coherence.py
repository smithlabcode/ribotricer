...
def get_periodicity(values):
    ...
    values = np.lib.pad(values,  (0, next_pow2_length- len(values)%next_pow2_length), padwithzeros)
    ...
    uniform_signal = np.lib.pad(uniform_signal, (0, next_pow2_length- len(uniform_signal)%next_pow2_length), padwithzeros)
