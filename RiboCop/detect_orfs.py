...
def export_orf_coverages(ribocop_index,
                         merged_alignments,
                         prefix,
                         report_all=False):
    """
...
def detect_orfs(bam, ribocop_index, prefix, protocol, read_lengths,
    ...
    annotated, refseq = parse_ribocop_index(ribocop_index)
    ...
    export_orf_coverages(ribocop_index, merged_alignments, prefix, report_all)
    now = datetime.datetime.now()
    print('{} ... {}'.format(
